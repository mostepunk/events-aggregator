...
def get_events_indexes() -> List[Dict]:
    ...
    return [
        ...
        # 8. Текстовый индекс для поиска по содержимому (создается последним)
        {
            ...
            "default_language": "english",  # Можно изменить на "russian" если нужно
        },
    ]
...
COLLECTIONS_INDEXES: Dict[str, List[Dict]] = {
    ...
    "rules": get_rules_indexes(),
    "metrics": get_metrics_indexes(),
    "users": get_users_indexes(),
    "index_metrics": get_index_metrics_indexes(),
}
